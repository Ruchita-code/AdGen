  ...
  return (
    <div className="min-h-screen text-white p-6 md:p-12 mt-28">
      <form onSubmit={handleGenerate} className="max-w-4xl mx-auto mb-40">
        ...
        <div className="flex gap-20 max-md:flex-col items-start justify-between">
          {/* Left col */}
          ...
          <div className="w-full">
            <div className="mb-4 text-gray-300">
              <label htmlFor="name" className="bock text-sm mb-4">Project Name</label>
            ...
            <div className="mb-4 text-gray-300">
              <label htmlFor="productName" className="bock text-sm mb-4">Product Name</label>
            ...
            <div className="mb-4 text-gray-300">
              <label htmlFor="productDescription" className="bock text-sm mb-4">Product Description <span className="text-xxs text-violet-400">(optional)</span></label>
              <textarea id="productDescription" rows={4} value={productDescription} onChange={(e) => setProductDescription(e.target.value)} placeholder="Enter the description of the product"
                className="w-full bg-white/3 rounded-lg border-2 p-4 text-sm border-violet-20010 focus:border-violet-500/50 outline-none resize-none transition-all" />
            </div>
            ...
            <div className="mb-4 text-gray-300">
              <label htmlFor="userPrompt" className="bock text-sm mb-4">user Prompt <span className="text-xxs text-violet-400">(optional)</span></label>
        ...
        <div className="flex justify-center mt-10">
          {quotaError && (
  <div className="w-full p-4 mb-6 bg-yellow-500/10 border border-yellow-500/30 rounded-xl text-yellow-300 text-sm text-center space-y-3">
    <p>⚠️ New content generation is currently unavailable due to API limits. You can explore previously generated outputs in the “Community” section.</p>
    <div className="flex justify-center mt-2">
      <a href="/community" className="px-4 py-2 bg-yellow-500/20 hover:bg-yellow-500/30 border border-yellow-500/30 rounded-lg transition">
        🌐 Visit Community
      </a>
    </div>
  </div>
