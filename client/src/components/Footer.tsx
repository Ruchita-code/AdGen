                ...
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-white/10">
                    <div>
                        ...
                        <p className="max-w-[410px] mt-6 text-sm leading-relaxed">
                            AdGen AI helps you create high-quality product ads in seconds using advanced AI technology.Upload your product, customize your vision, and let AI turn it into scroll-stopping content.
                        </p>
                    </div>
